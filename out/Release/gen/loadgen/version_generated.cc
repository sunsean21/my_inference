...
const std::string& LoadgenBuildDateLocal() {
  static const std::string str = "2020-03-08T23:00:12.405277";
  return str;
}

const std::string& LoadgenBuildDateUtc() {
  static const std::string str = "2020-03-09T03:00:12.405300";
  return str;
}

const std::string& LoadgenGitRevision() {
  static const std::string str = "96f2331481";
  return str;
}

const std::string& LoadgenGitCommitDate() {
  static const std::string str = "2020-03-08T21:16:02-04:00";
  return str;
}
...
const std::string& LoadgenGitStatus() {
 ...
 M ../MakefileGnProj/.ninja_log
 M ../MakefileGnProj/gen/loadgen/version_generated.cc)LGVG_RSLD";
  return str;
}

const std::string& LoadgenGitLog() {
  static const std::string str = R"LGVG_RSLD(96f23314812ca06ee5f2cf55438e5b5a1f9e11b7 add version_generated.cc
...
7a084d39c9324470e489d93c5d4917f13d62bd91 remove assert which blocks runs (#502))LGVG_RSLD";
  return str;
}

const std::string& LoadgenSha1OfFiles() {
  static const std::string str = R"LGVG_RSLD(427103382e6bb37050fb5654bc93404849ce21b2 /.DS_Store
